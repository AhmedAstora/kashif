...
import 'package:kashif/Screens/MapCityScreen/ui/widget/pyramids_shots_widget.dart';
...
class PyramidsShotsScreen extends StatelessWidget {
  PyramidsShotsScreen({super.key});
        ...
        return Scaffold(
          body: Container(
            ...
            decoration: BoxDecoration(
              gradient: AppColor.getGradientMap(stops: [0, 0.7]),
            ),
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomText(
                      'Here are the friends who reached this destination and completed the mission',
                      fontSize: 16.sp,
                    ),
                  ),
                  ...
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (_, i) => PyramidsShotsWidget(),
                    ),
                  ),
                ],
              ),
