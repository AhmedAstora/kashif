...
class StackedOverlapCarousel extends StatefulWidget {
  const StackedOverlapCarousel({super.key});

  @override
  State<StackedOverlapCarousel> createState() => _StackedOverlapCarouselState();
}

class _StackedOverlapCarouselState extends State<StackedOverlapCarousel> {
