...
class SearchMissionsShotsWidget extends StatefulWidget {
  ...
  const SearchMissionsShotsWidget({
    super.key,
  ...
  @override
  State<SearchMissionsShotsWidget> createState() => _SearchTextFieldWidgetState();
}

class _SearchTextFieldWidgetState extends State<SearchMissionsShotsWidget> {
  bool hasText = false;
